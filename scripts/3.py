...
PARAM_NAMES            = ('alpha1', 'alpha2', 'lmbd', 'beta1', 'beta2', 'p', 'w0', 'k')
NOPTIM                 = 1000
...
def main():
    ...
    HYBRID_SINGLE_PARAMS = join(RESULTS_DIRECTORY, "3-condition.csv")
    ...
    # Fit model
    stan_model = CmdStanModel(stan_file="3.stan")  # <-- your modified Stan file name
    ...
    full_results_df.to_csv(os.path.join(RESULTS_DIRECTORY, f"3-{condition}-metrics.csv"), index=False)
